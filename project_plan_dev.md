...
## Feature Development
When you work on a feature, you are always required to create a **branch** for the feature and **merge** the branch back to the BlockUser_main branch with **pull requests** when the feature is completed. Note: the below should remind you of the "workflow" we covered in the first lab this term. Please review the details of that document in addition to the below, which provides additional details about how the process works on GitHub. 
...
When you finish working on a feature, you are required to merge the feature branch back to the BlockUser_main branch with a **pull request**.
...
2. Give a meaningful title and description for the pull request, remember please make the name consistent. 
   ...
   2.1 First make sure that you are merging from the feature branch to the BlockUser_main branch (see blue box).
